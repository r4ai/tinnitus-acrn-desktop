    ...
    return (
      <div className="App">
          ...
          <div className="container">
            <div className="navbar-header navbar-right">
              <ul className="nav navbar-nav">
                <li>
                  <a href="http://github.com/generalfuzz/acrn-react">Source</a>
                </li>
                <li>
                  <a href="http://generalfuzz.net/contact.php">Contact</a>
                </li>
                <li>
                  <a href="http://www.generalfuzz.net">Music</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container ">
          ...
          <p>
            Inspired by{" "}
            <a href="http://www.tinnitustalk.com/threads/acoustic-cr%C2%AE-neuromodulation-do-it-yourself-guide.1469/">
              this
            </a>{" "}
            thread on <a href="http://www.tinnitustalk.com">tinnitustalk.com</a>{" "}
            and{" "}
            <a href="http://www.reddit.com/r/tinnitus/comments/15x99f/recent_tinnitus_study_and_my_attempt_at_utilizing/">
              this
            </a>{" "}
            reddit thread.
          </p>
